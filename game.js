...
// allow reassigning if element missing so we can recreate it
  ...
  onValue(gameRef, async (gsnap) => {
    ...
    if (meNode.powerShots !== undefined) {
      ...
      if (usePowerBtn) {
        ...
        usePowerBtn.textContent = myPowerShots > 0 ? `Use PowerShot (${myPowerShots})` : "Use PowerShot (0)";
